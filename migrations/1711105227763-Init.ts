...
export class Init1711105227763 implements MigrationInterface {
    name = 'Init1711105227763'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`contracts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`type\` varchar(255) NOT NULL, \`primePercent\` int NOT NULL, \`primeTravelLimit\` int NOT NULL, \`amount\` int NOT NULL, \`startDate\` datetime NOT NULL, \`endDate\` datetime NOT NULL, \`isClosed\` tinyint NOT NULL DEFAULT 0, \`description\` varchar(255) NOT NULL, \`authorId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`companies\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`shortname\` varchar(200) NOT NULL, \`longname\` varchar(255) NOT NULL, \`email\` varchar(200) NOT NULL, \`numTel\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`numPostal\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`numRccm\` varchar(255) NOT NULL, \`numIfu\` varchar(255) NOT NULL, \`taxSystem\` varchar(255) NOT NULL, \`taxDivision\` varchar(255) NOT NULL, \`avatar\` varchar(255) NULL, UNIQUE INDEX \`email\` (\`email\`), UNIQUE INDEX \`numRccm\` (\`numRccm\`), UNIQUE INDEX \`numIfu\` (\`numIfu\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`travels\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`refTravel\` varchar(100) NOT NULL, \`signatureDate\` datetime NULL, \`product\` varchar(100) NOT NULL, \`status\` varchar(255) NULL, \`departureDate\` datetime NULL, \`arrivalDate\` datetime NULL, \`departureCity\` varchar(255) NOT NULL, \`arrivalCity\` varchar(255) NOT NULL, \`truckWeight\` int NULL, \`departureWeight\` int NULL, \`arrivalWeight\` int NULL, \`companyId\` int NULL, \`invoiceId\` int NULL, \`truckId\` int NULL, UNIQUE INDEX \`refTravel\` (\`refTravel\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`password_reset\` (\`token\` varchar(255) NOT NULL, \`newEmail\` varchar(255) NOT NULL, \`validUntil\` datetime NOT NULL, \`userId\` int NULL, PRIMARY KEY (\`token\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(100) NOT NULL, \`email\` varchar(200) NOT NULL, \`password\` varchar(255) NOT NULL, \`username\` varchar(200) NOT NULL, \`roles\` text NOT NULL, \`isAccountDisabled\` tinyint NOT NULL DEFAULT 0, \`status\` varchar(255) NOT NULL, \`isAssigned\` tinyint NOT NULL DEFAULT 0, \`numTel\` varchar(255) NOT NULL, \`avatar\` varchar(255) NULL, \`attempts\` tinyint NOT NULL DEFAULT '0', UNIQUE INDEX \`email\` (\`email\`), UNIQUE INDEX \`username\` (\`username\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`files\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`label\` varchar(200) NOT NULL, \`description\` varchar(255) NOT NULL, \`notification\` tinyint NOT NULL DEFAULT 0, \`category\` text NOT NULL, \`extension\` varchar(255) NOT NULL, \`deliverAt\` datetime NULL, \`expireAt\` datetime NULL, \`size\` int NOT NULL, \`link\` varchar(255) NOT NULL, \`authorId\` int NULL, \`companyId\` int NULL, \`expenseId\` int NULL, \`vehicleId\` int NULL, \`travelId\` int NULL, \`invoiceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`expenses\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`label\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`unitPrice\` int NOT NULL, \`unitNumber\` int NOT NULL, \`categories\` text NOT NULL, \`vehicleId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`vehicles\` (\`id\` int NOT NULL AUTO_INCREMENT, \`numImat\` varchar(100) NOT NULL, \`vehicleType\` varchar(255) NOT NULL, \`vehicleColor\` varchar(255) NOT NULL, \`brand\` varchar(255) NOT NULL, \`vehicleModel\` varchar(255) NOT NULL, \`volume\` int NOT NULL, \`axleNumber\` int NOT NULL, \`isAssigned\` tinyint NOT NULL DEFAULT 0, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`numImat\` (\`numImat\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
