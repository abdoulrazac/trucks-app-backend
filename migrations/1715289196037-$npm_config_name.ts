...
export class  $npmConfigName1715289196037 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`files\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`label\` varchar(200) NOT NULL, \`description\` varchar(255) NOT NULL, \`notification\` tinyint NOT NULL DEFAULT 0, \`categories\` text NOT NULL, \`extension\` varchar(255) NOT NULL, \`deliverAt\` datetime NULL, \`expireAt\` datetime NULL, \`size\` int NOT NULL, \`link\` varchar(255) NOT NULL, \`authorId\` int NULL, \`companyId\` int NULL, \`expenseId\` int NULL, \`vehicleId\` int NULL, \`travelId\` int NULL, \`invoiceId\` int NULL, \`contractId\` int NULL, \`breakdownId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
